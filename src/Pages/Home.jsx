        ...
        <div>
            ...
            <div className="container-fluid" style={{ backgroundColor: '#656565' }}>
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="h-100 d-flex align-items-center mt-0 mt-lg-3">
                            <img src="https://img.freepik.com/free-photo/georgian-eggplant-roulettes-table_140725-9215.jpg?t=st=1735925307~exp=1735928907~hmac=b5ef6a0b5c70abd9603ae945aea74e8b9b2d34eb4b540e767534ce0d06923bb9&w=360" alt="" className="w-100 rounded-3 img-thumbnail mb-2" style={{height:450}}/>
                        </div>
                    </div>
                </div>
            </div>
